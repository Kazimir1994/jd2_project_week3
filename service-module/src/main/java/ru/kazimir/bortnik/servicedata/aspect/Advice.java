package ru.kazimir.bortnik.servicedata.aspect;
...
import ru.kazimir.bortnik.repository.AuditItemRepository;
...
public class Advice {
    ...
    @Pointcut("execution(* ru.kazimir.bortnik.repository.ItemsRepository.add(..))")
    ...
    @Pointcut("execution(* ru.kazimir.bortnik.repository.ItemsRepository.update(..))")
